...
function getCanadaFlag(){
    ...
    canFlag.classList = "w-39 h-31 border-2 flex m-10";

    let redStrapCanada = document.createElement("div");
    redStrapCanada.classList = "bg-red-500 h-30 w-13";

    let whiteStrapCanada = document.createElement("div");
    whiteStrapCanada.classList = "bg-white w-13 h-30 content-center p-2";

    let leaf = document.createElement("img");
    leaf.src = "./canada.png";
    leaf.alt = "mapleleaf";
    leaf.classList = "w-10 h-9";
    whiteStrapCanada.appendChild(leaf);

    let redStrapCanada2 = document.createElement("div");
    redStrapCanada2.classList = "bg-red-500 h-30 w-13";

    canFlag.appendChild(redStrapCanada)
    canFlag.appendChild(whiteStrapCanada);
    canFlag.appendChild(redStrapCanada2);

    return canFlag;
}

function getUnitedArabEmiratesFlag(){
    let unitedFlag = document.createElement("div");
    unitedFlag.classList = "w-41 h-30 border-2 m-10 flex";

    let firstPortion = document.createElement("div");
    firstPortion.classList = "w-12 h-30 bg-red-500";

    let secondPortion = document.createElement("div");
    secondPortion.classList = "w-29 h-30";
    
    let firstStrap = document.createElement("div");
    firstStrap.classList = "bg-green-500 w-29 h-10";

    let secondStrap = document.createElement("div");
    secondStrap.classList = "bg-white w-29 h-10";

    let thirdStrap = document.createElement("div");
    thirdStrap.classList = "bg-black w-29 h-10";

    secondPortion.appendChild(firstStrap);
    secondPortion.appendChild(secondStrap);
    secondPortion.appendChild(thirdStrap);

    unitedFlag.appendChild(firstPortion);
    unitedFlag.appendChild(secondPortion);
...
function getItalyFlag(){
    ...
    italyFlag.classList = "w-42 h-31 border-2 flex m-10";

    let greenStrapItaly = document.createElement("div");
    greenStrapItaly.classList = "bg-green-500 w-14 h-30";

    let whiteStrapItaly = document.createElement("div");
    whiteStrapItaly.classList = "bg-white w-14 h-30";

    let redStrapItaly = document.createElement("div");
    redStrapItaly.classList = "bg-red-500 w-14 h-30";

    italyFlag.appendChild(greenStrapItaly);
    italyFlag.appendChild(whiteStrapItaly);
    italyFlag.appendChild(redStrapItaly);
...
function getKoreaFlag(){
    ...
    koreaFlag.classList = "w-41 m-10 h-30 border-2";

    let koreaWhiteStrap = document.createElement("div");
    koreaWhiteStrap.classList = "h-full w-full bg-white grid grid-cols-3 grid-rows-3";
...
btn.addEventListener("click",()=>{
    let countryName = inputBar.value.trim().toLowerCase();
    inputBar.value = "";
    country = countryName;
    flagBox.innerHTML = "";
    if(country == "russia")
   ...
   {  console.log(country);
    ...
    { console.log(country);
     flagBox.appendChild(getUnitedArabEmiratesFlag());}
